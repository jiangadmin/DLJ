...
//	private EyeView mEyeView; // 显示提示框的view界面
    ...
    public static void start(Context context) {
        ...
        intent.setClass(context, Isir_Activity.class);
    ...
    private void initUI() {
        ...
        cbDetectFakeEye1.setOnCheckedChangeListener((buttonView, isChecked) -> Config.IfDetectFakeEye = isChecked);
        cbDetectFakeEye2 = findViewById(R.id.cb_detectfake2);
        cbDetectFakeEye2.setOnCheckedChangeListener((buttonView, isChecked) -> Config.IfDetectFakeEye = isChecked);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.start_register_rb: // 虹膜注册
                ...
                hideGuideView();
                recyclerViewAdapter = new ShowUserInfoRecyclerViewAdapter(this, userMap);
...
//                    customTextViewDialog.show();
            ...
            case R.id.continue_identify_rb: //连续识别
                ...
                hideGuideView();
                recyclerViewAdapter = new ShowUserInfoRecyclerViewAdapter(Isir_Activity.this, userMap);
                mRecyclerView.setAdapter(recyclerViewAdapter);
                result = sqliteDataBase.queryAllResult();
                if (result) {
                    if (isActive) {
...
//                    Toast.makeText(getApplicationContext(), "识别失败，code:" + ifSuccess, Toast.LENGTH_SHORT).show();
                    ...
                    LogUtil.e("iris_info", "识别完成，识别失败，code:" + ifSuccess + ", 总耗时：" + (System.currentTimeMillis() - startTime)
                            + ", 算法耗时：" + ((DnSmpDetect.getInstance(Isir_Activity.this).endTime - DnSmpDetect.getInstance().startTime)));
...
//                    surfaceviewHandler.sendEmptyMessage(5);
                ...
                Isir_Activity.this.vibrator.vibrate(new long[]{0, 50}, 1);
...
//                soundDown.pause();
    ...
    private CameraPreviewCallback uvcPreviewCallback = new CameraPreviewCallback.UVCPreviewCallback() {
        ...
        public void onCameraConnected() {
            runOnUiThread(() -> Toast.makeText(getApplicationContext(), "USB设备已连接", Toast.LENGTH_SHORT).show());
        }
