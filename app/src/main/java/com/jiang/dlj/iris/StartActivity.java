...
public class StartActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frontRadioBtn.setOnClickListener(v -> mCameraId = 3);

        rearRadioBtn.setOnClickListener(v -> mCameraId = 2);
...
//				Log.e("tony", "选中的摄像头ID: " + mCameraId);
            ...
            Intent intent = new Intent(StartActivity.this, Isir_Activity.class);
